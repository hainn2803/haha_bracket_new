...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mass-fraction", type=float, default=0.3)
...
def main() -> None:
    ...
    if earlier_d_sites:
        ...
        stage_evaluation = calibrate_against_frozen_d(ctx, graded, stage_ranking["selector"]["ranked"], d_current, r_weights, r_readout, strengths)
